...
noble.on('discover', (peripheral) => {
  ...
  //     peripheral.advertisement.localName == 'd'
  //   )
  // )
  //   return;

  console.log(peripheral.advertisement.serviceUuids[1]);
...
noble.startScanning(['b0ef'], true); // any service UUID, allow duplicates
