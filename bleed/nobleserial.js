...
var DEFAULT_SERIAL_SERVICE = '0000dfb100001000800000805f9b34fb';
...
function BLESerialPort(options) {
  ...
  this.receiveCharacteristic =
    options.receiveCharacteristic || DEFAULT_RECEIVE_CHARACTERISTIC;
  this.transmitCharacteristic =
    options.transmitCharacteristic || DEFAULT_TRANSMIT_CHARACTERISTIC;
          ...
          services.forEach(function (service) {
            ...
            service.discoverCharacteristics([], function (
              ...
              characteristics.forEach(function (characteristic) {
                ...
                if (
                  compareUUIDs(self.transmitCharacteristic, characteristic.uuid)
                ) {
                  self.transmit = characteristic;
                } else if (
                  compareUUIDs(self.receiveCharacteristic, characteristic.uuid)
                ) {
